...
|-------|-------|
| Ticket | psc-0024 |
| Title | Update AGENTS.md with SOLID, DRY, TDD, Clean Architecture, module docs, Mermaid/C4 requirements |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [documentation] [architecture] | **Roster:** SW, DX
