...
|-------|-------|
| Ticket | psc-0018 |
| Title | Add disconnect detection and auto-reconnect with --reconnect-timeout |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [hardware] [security] | **Roster:** SW, TX, DX, HW, SX
