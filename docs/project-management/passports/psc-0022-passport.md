...
|-------|-------|
| Ticket | psc-0022 |
| Title | Create docs/modules/ documentation for all modules with state machines and examples |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [documentation] | **Roster:** SW, DX
