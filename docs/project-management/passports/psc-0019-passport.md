...
|-------|-------|
| Ticket | psc-0019 |
| Title | Add JSONL replay input for offline scan data processing |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [wireless] [security] | **Roster:** SW, TX, DX, WX, SX
