...
|-------|-------|
| Ticket | psc-0020 |
| Title | Add --events=none flag to disable event stream generation |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** — | **Roster:** SW, TX, DX
