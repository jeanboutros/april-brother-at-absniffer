...
|-------|-------|
| Ticket | psc-0028 |
| Title | Implement SqliteProfileStorage for persistent multi-week behavioral analysis |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [architecture] [persistence] | **Roster:** SW, TX
