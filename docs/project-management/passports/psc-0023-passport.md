...
|-------|-------|
| Ticket | psc-0023 |
| Title | Extract DeviceRegistry as a reusable module with LRU eviction and per-MAC state |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [architecture] | **Roster:** SW, TX, DX
