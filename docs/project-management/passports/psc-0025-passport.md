...
|-------|-------|
| Ticket | psc-0025 |
| Title | Implement presence_analyzer module (timeline, features, classifier, profiles) |
| Created | 2026-06-13 |
| PM | pm |
...
- [ ] A0: Task Definition — acceptance criteria, files, constraints, test strategy, doc plan. **Domain classification:** [architecture] [wireless] | **Roster:** SW, TX, DX, WX
